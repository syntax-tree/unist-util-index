...
test('index.get', function(t) {
  ...
  t.deepEqual(index.get('red'), [$('[id=2]'), $('[id=6]'), $('[id=11]')])
...
test('empty index', function(t) {
  t.deepEqual(new Index(null, 'foo').get('bar'), [])
  t.deepEqual(new Index('foo').get('bar'), [])
  t.end()
})
...
test('computed keys', function(t) {
  ...
  t.deepEqual(index.get(4), [$('[id=0]'), $('[id=2]'), $('[id=3]')])
  t.deepEqual(index.get(0), [])
  t.deepEqual(index.get(5), [$('[id=1]'), $('[id=4]')])

  t.deepEqual(new Index(ast, 'node', xPlusY).get(4), [$('[id=2]'), $('[id=3]')])
